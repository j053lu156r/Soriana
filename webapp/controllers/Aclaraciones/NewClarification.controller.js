sap.ui.define([
	...
	return Controller.extend("demo.controllers.Aclaraciones.NewClarification", {
		onInit: function () {
        ...
        onCancel: function () {
            console.log("entro");
            this.goToMainAclaraciones();
        },
        goToMainAclaraciones: function () {
            this.oRouter.navTo("Aclaraciones");
            this.clearFields();
        },
	});
});