sap.ui.define([
    ...
    return Controller.extend("demo.controllers.CargoNS.DetailCPNS", {
        onInit: function () {
         ...
         /*
          ...
          //  this.configFilterLanguage(this.getView().byId("filterBar"));
			...
			this.oRouter.getRoute("detailAcuerdosCPNS").attachPatternMatched(this._onDocumentMatched, this);
...
*/
		...
		handleFullScreen: function () {
			...
			this.oRouter.navTo("detailAcuerdosCPNS", {
        ...
        onListItemPress: function (oEvent) {
            ...
            this.getOwnerComponent().getRouter().navTo("detailDetailCPNS",
                {
