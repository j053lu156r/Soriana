sap.ui.define([
    ...
    return Controller.extend("demo.controllers.CargoNS.DetailFANS", {
        onInit: function () {
         ...
         /*
          ...
          //  this.configFilterLanguage(this.getView().byId("filterBar"));
			...
			this.oRouter.getRoute("detailAcuerdosFANS").attachPatternMatched(this._onDocumentMatched, this);
        ...
        onListItemPress: function (oEvent) {
            ...
            this.getOwnerComponent().getRouter().navTo("detailDetailFANS",
                {
