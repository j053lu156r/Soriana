sap.ui.define([
    ...
    return Controller.extend("demo.controllers.CargoNS.DetailECNS", {
        onInit: function () {
         ...
         /*
          ...
          //  this.configFilterLanguage(this.getView().byId("filterBar"));
			...
			this.oRouter.getRoute("detailAcuerdosECNS").attachPatternMatched(this._onDocumentMatched, this);
        ...
        onListItemPress: function (oEvent) {
           ...
           // detailDetailAcuEC
            this.getOwnerComponent().getRouter().navTo("detailDetailECNS",
                {
