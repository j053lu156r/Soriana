sap.ui.define([
    ...
    return Controller.extend("demo.controllers.CargoNS.Detail", {
        onInit: function () {
            ...
            this.oRouter.getRoute("detailCargoNS").attachPatternMatched(this._onDocumentMatched, this);
        ...
        handleFullScreen: function () {
            ...
            this.oRouter.navTo("detailCargoNS",
                {
                    layout: sNextLayout,
