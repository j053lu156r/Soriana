sap.ui.define([
    ...
    return Controller.extend("demo.controllers.CargoNS.DetailDetailCPNS", {
        onInit: function () {
            ...
            this.oRouter.getRoute("detailDetailCPNS").attachPatternMatched(this._onDocumentMatched, this);
