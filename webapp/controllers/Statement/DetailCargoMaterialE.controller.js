sap.ui.define([
	...
	return Controller.extend("demo.controllers.Statement.DetailCargoMaterialE", {
		onInit: function () {
			...
			this.oRouter.getRoute("detailCargoMatsBoletinVta2").attachPatternMatched(this._onDocumentMatched, this);
		...
		handleFullScreen: function () {
			...
			this.oRouter.navTo("detailCargoMatsBoletinVta2", 
                {
                    layout: sNextLayout, 
