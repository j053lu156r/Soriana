sap.ui.define([
	...
	return Controller.extend("demo.controllers.BoletinVta.DetailCargoCP", {
		onInit: function () {
			...
			this.oRouter.getRoute("detailCargoBoletinVtaCP").attachPatternMatched(this._onDocumentMatched, this);
		...
		onListItemPress: function (oEvent) {
            ...
            var oNextUIState = this.getOwnerComponent().getHelper().getNextUIState(4);
            this.getOwnerComponent().getRouter().navTo("detailCargoMatsBoletinVtaCP",
                {
		...
		handleFullScreen: function () {
			...
			this.oRouter.navTo("detailCargoBoletinVtaCP", 
                {
                    layout: sNextLayout, 
		...
		handleClose: function () {
			//var sNextLayout = this.oModel.getProperty("/actionButtonsInfo/endColumn/exitFullScreen");
            //sNextLayout = sap.f.LayoutType.ThreeColumnsEndExpanded;
