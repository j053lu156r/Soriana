sap.ui.define([
	...
	return Controller.extend("demo.controllers.BoletinVta.DetailCargoMaterialCP", {
		onInit: function () {
			...
			this.oRouter.getRoute("detailCargoMatsBoletinVtaCP").attachPatternMatched(this._onDocumentMatched, this);
		...
		handleFullScreen: function () {
			...
			this.oRouter.navTo("detailCargoMatsBoletinVtaCP", 
                {
                    layout: sNextLayout, 
